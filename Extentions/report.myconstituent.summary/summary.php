 ...
 *
 */
class report_myconstituent_summary extends CRM_Report_Form {
      ...
      array(
        ...
        array(
		  ...
		  'required' => TRUE,
  		  ...
  		  'job_title' => array('title' => ts('Job Title'),
		  'required' => TRUE,
	  ),
          'id' =>
          array(
  ...
  function alterDisplay(&$rows) {
	...
	if ( array_key_exists('civicrm_contact_gender_id', $row) ) {
                if ( $value = $row['civicrm_contact_gender_id'] ) {
                    $gender = CRM_Core_PseudoConstant::getValue('CRM_Contact_DAO_Contact', 'gender_id',$value);
                    $rows[$rowNum]['civicrm_contact_gender_id'] = $gender;
                }
                $entryFound = true;
            }
