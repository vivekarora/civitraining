    ...
    {if $add }
      <div class="crm-summary-row">
        ...
        <div class="crm-content">
          ...
          {$add.display|nl2br}
	{if $add.postal_code}
					<a href="http://www.neighbourhood.statistics.gov.uk/dissemination/NeighbourhoodSummary.do?width=1440&a=3&i=1001&m=0&s=1284550555705&enc=1&profileSearchText={$add.postal_code}" target=_blank>Neighbourhood Address</a>
       {/if}
        </div>
      </div>
